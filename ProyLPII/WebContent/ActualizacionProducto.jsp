...
<body>
	<div class="container">
		...
		<form method="post" enctype="multipart/form-data" class="form"
			action="CActualizarProducto">

			<fieldset class="form-fieldset ui-input __first">
				<input type="text" id="codigo" readonly="true" name="codigo"
					tabindex="0" value="<%=p.getCodigo()%>" /> <label for="nom_Usu">
					<span data-text="Codigo">Codigo</span>
				</label>
			</fieldset>

			<div class="caja">
				<select name="Id_TipoCat" id="Id_TipoCat">
			...
			<fieldset class="form-fieldset ui-input __first">
				<input type="text" id="nom_Prod" name="nom_Prod" tabindex="0"
					value="<%=p.getDescripcion()%>" /> <label for="nom_Prod">
			...
			<fieldset class="form-fieldset ui-input __first">
				<input type="text" id="precio_Prod" name="precio_Prod" tabindex="0"
					value="<%=p.getPrecio()%>" /> <label for="precio_Prod"> <span
					data-text="Precio">Precio</span>
				</label>
			</fieldset>

			<fieldset class="form-fieldset ui-input __first">
				<input type="text" id="stock_Prod" name="stock_Prod" tabindex="0"
					value="<%=p.getStock()%>" /> <label for="stock_Prod"> <span
					data-text="Stock de Producto">Stock de Producto</span>
				</label>
			</fieldset>

			<fieldset class="form-fieldset ui-input __first">
				<input type="file" id="file" name="file" tabindex="0" /> <label
