...
<body>
	...
	<section class="products">
		...
		<%
			ArrayList<DetalleDeliveryDTO> carro = (ArrayList<DetalleDeliveryDTO>) request.getSession()
					.getAttribute("carroD");
		...
		<section class="products__header">
			<form action="RealizarOrden">
				...
				<input type="button" value="Ordenar" id="btordenar"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
								...
								<form>
									<div class="form-group">
										<label for="nombre" class="col-form-label">Nombre
											Completo:</label> <input type="text" class="form-control" id="nomDel"
											name="nomDel" tabindex="0" maxlength="80"
											pattern="[A-Za-z]{1,80}"
											title="Introduce entre 1 y 80 letras" required>
									</div>
									<div class="form-group">
										<label for="nombre" class="col-form-label">DNI:</label> <input
											type="text" class="form-control" id="dniDel" name="dniDel"
											tabindex="0" maxlength="8" pattern="[0-9]{8}"
											title="Introduce solo 8 digitos" required>
									</div>
									<div class="form-group">
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<button class="btn btn-outline-primary" type="button"
													onclick="obtener()">Obtener Dirección</button>
											</div>
											<input type="text" id="dir" name="dir" class="form-control"
												placeholder="Direccion" aria-label=""
												aria-describedby="basic-addon1" disabled>
										</div>
									</div>
									<div class="form-group">
										<label for="nombre" class="col-form-label" required>Pago:</label>
										<select class="custom-select mr-sm-2" id="pagoDel"
											name="pagoDel" required>
									...
									<div class="form-group">
										<label for="message-text" class="col-form-label">Observaciones
											para el pedido:</label>
										<textarea class="form-control" id="obsDel" name="obsDel"
											tabindex="0" maxlength="80" pattern="[A-Za-z]{1,80}"
											title="Introduce entre 1 y 80 letras" required></textarea>
									</div>
									<div class="form-group">
							...
							<div class="modal-footer">
								...
								<a id="llamarO" onclick="llamarServletOrdenar()"
									class="btn btn-primary">Ordenar</a>
							</div>
						</div>
					</div>
				</div>
			...
			<article class="products__item">
				...
				<section class="product-desc">
					<h3>
						...
						<%=p.getDescripcion()%></h3>
					<h3>
						Precio : S/<%=dt.getPrecioProducto()%></h3>
					<h3>
						Cantidad :
						<%=dt.getCantidad()%></h3>
					<h3>
						Subtotal : S/<%=dt.getSubtotal()%></h3>
				</section>
				<div class="wrap-item-button">
					<a id="llamar"
						onclick="llamarServlet(<%=p.getCodigo()%>,<%=dt.getCantidad()%>)"
						class="item-button">Eliminar</a>
				</div>
