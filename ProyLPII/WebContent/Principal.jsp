...
<body>
	<header id="menu-flex" class="menu-flex">
		<nav class="menu">
			...
			<div id="links" class="links">
				<a href="Principal.jsp" class="links-menu links-menu-active"> <i
					class="fa fa-home icons-menu" aria-hidden="true"></i> Inicio
	...
	<div class="container">
		<header id="cabecera">
			...
			<h1 id="texto2">
				¿HAMBRIENTO?<br> ORDENE EN <br>CIRBETEK DELIVERY
			</h1>
		</header>
		<arcticle class="artComida">
		<center>
			<img class="imgCambio" src="img/pescados.jpg" alt="">
		</center>

		</arcticle>
		<arcticle class="artComida">
		<center>
			<img class="imgCambio" src="img/Carnes.jpg" alt="">
		</center>
		</arcticle>
		<arcticle class="artComida">
		<center>
			<img class="imgCambio" src="img/rapida.jpg" alt="">
		</center>
		</arcticle>
		<arcticle class="artComida">
		<center>
			<img class="imgCambio" src="img/pizza.jpg" alt="">
		</center>
		</arcticle>
	</div>
